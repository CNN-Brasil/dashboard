                    ...
                    <Infos id='infos'>
                        ...
                        <Info>
                            ...
                            <InfoGeral>
                                ...
                                <InfoNumbers><strong>Total {state.youtube.at(-1) || state.ibope.at(-1) ? renderNumberWitchCommas(state.youtube.at(-1)[1] + state.ibope.at(-1)[4]) : '0'} UV</strong> {(state.total.at(-1) && state.total.at(-1)[4] > 0) && <Porcentage porcentange={state.total.at(-1) && renderPorcentage(state?.total?.at(-1)[4], state?.total?.at(-2)[4])}>{state.total.at(-1) && renderTotal(state?.total?.at(-1)[4], state?.total?.at(-2)[4])}%</Porcentage>} </InfoNumbers>
                            </InfoGeral>
                        </Info>
