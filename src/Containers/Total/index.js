                    ...
                    <Infos id='infos'>
                        ...
                        <Info>
                            ...
                            <InfoGeral>
                                ...
                                <InfoNumbers><strong>Total {state.youtube.at(-1) || state.ibope.at(-1) ? renderNumberWitchCommas(state.youtube.at(-1)[1] + state.ibope.at(-1)[1]) : '0'} UV</strong> {(state.total.at(-1) && state.total.at(-1)[1] > 0) && <Porcentage porcentange={state.total.at(-1) && renderPorcentage(state?.total?.at(-1)[1], state?.total?.at(-2)[1])}>{state.total.at(-1) && renderTotal(state?.total?.at(-1)[1], state?.total?.at(-2)[1])}%</Porcentage>} </InfoNumbers>
                            </InfoGeral>
                        </Info>
                        ...
                        <Info>
                            ...
                            <InfoGeral>
                                ...
                                <InfoNumbers><strong>Total {state.youtube.at(-1) || state.ibope.at(-1) ? renderNumberWitchCommas(state.youtube.at(-1)[2] + state.ibope.at(-1)[2]) : '0'} UV</strong> {(state.total.at(-1) && state.total.at(-1)[2] > 0) && <Porcentage porcentange={state.total.at(-1) && renderPorcentage(state?.total?.at(-1)[2], state?.total?.at(-2)[2])}>{state.total.at(-1) && renderTotal(state?.total?.at(-1)[2], state?.total?.at(-2)[2])}%</Porcentage>} </InfoNumbers>
                            </InfoGeral>
                        </Info>
                        ...
                        <Info>
                            ...
                            <InfoGeral>
                                ...
                                <InfoNumbers><strong>Total {state.youtube.at(-1) || state.ibope.at(-1) ? renderNumberWitchCommas(state.youtube.at(-1)[3] + state.ibope.at(-1)[3]) : '0'} UV</strong> {(state.total.at(-1) && state.total.at(-1)[3] > 0) && <Porcentage porcentange={state.total.at(-1) && renderPorcentage(state?.total?.at(-1)[3], state?.total?.at(-2)[3])}>{state.total.at(-1) && renderTotal(state?.total?.at(-1)[3], state?.total?.at(-2)[3])}%</Porcentage>} </InfoNumbers>
                            </InfoGeral>
                        </Info>
                        ...
                        <Info>
                            ...
                            <InfoGeral>
                                ...
                                <InfoNumbers><strong>Total {state.youtube.at(-1) || state.ibope.at(-1) ? renderNumberWitchCommas(state.youtube.at(-1)[4] + state.ibope.at(-1)[4]) : '0'} UV</strong> {(state.total.at(-1) && state.total.at(-1)[4] > 0) && <Porcentage porcentange={state.total.at(-1) && renderPorcentage(state?.total?.at(-1)[4], state?.total?.at(-2)[4])}>{state.total.at(-1) && renderTotal(state?.total?.at(-1)[4], state?.total?.at(-2)[4])}%</Porcentage>} </InfoNumbers>
                            </InfoGeral>
                        </Info>
                        ...
                        <Info>
                            ...
                            <InfoGeral>
                                ...
                                <InfoNumbers><strong>Total {state.youtube.at(-1) || state.ibope.at(-1) ? renderNumberWitchCommas(state.youtube.at(-1)[5] + state.ibope.at(-1)[5]) : '0'} UV</strong> {(state.total.at(-1) && state.total.at(-1)[5] > 0) && <Porcentage porcentange={state.total.at(-1) && renderPorcentage(state?.total?.at(-1)[5], state?.total?.at(-2)[5])}>{state.total.at(-1) && renderTotal(state?.total?.at(-1)[5], state?.total?.at(-2)[5])}%</Porcentage>}</InfoNumbers>
                            </InfoGeral>
                        </Info>
                    </Infos>
                    </Grid>
